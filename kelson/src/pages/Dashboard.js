...
//     // console.log("avgbatchdatamap called ", data)
//     setAvgBatchTime(data[0].avg_batch_time)
//     console.log(data[0].avg_batch_time)
//     setAvgWater(data[1].avg_water)
//     setSandminTemp(data[2].sand_min_temp)
//     setSandmaxTeamp(data[2].sand_max_temp)
...
//             mr: 5
//           }}>
//             <Typography variant='h6' gutterBottom>Cycle No :</Typography>
//             <Typography sx={{ fontWeight: 'bold' }} variant='h6' gutterBottom>{cycleNo}</Typography>

//             <Typography variant='h6' gutterBottom>Time :</Typography>
//             <Typography sx={{ fontWeight: 'bold' }} variant='h6' gutterBottom>{time}</Typography>
...
//             alignItems: 'center',
//             padding: '8px',
//             width: '33%',  // Adjust width of each section
//             boxSizing: 'border-box', // Prevents overflow issues
//           }}>
//             <Box>
//               <Typography sx={{ fontWeight: '600', background: '#ADDFFF', p: 0.5,paddingRight:10,paddingLeft:10 }} variant='h6'>Today</Typography>
//               <Typography variant='h6'>{formattedDate}</Typography>
//             </Box>
...
//               />
//               <Box sx={{ display: 'flex', flexDirection: 'column', }}>
//                 <Typography sx={{ whiteSpace: 'pre-line' }} variant='h8'>Avg Batch Time: {'\n'} <strong>{avgBatchTime} sec</strong></Typography>
//                 <Typography sx={{ whiteSpace: 'pre-line' }} variant='h8'>Avg Water: {'\n'} <strong>{(avgWater ?? 0).toFixed(1)} ltr</strong></Typography>
//                 <Typography sx={{ whiteSpace: 'pre-line' }} variant='h8'>Sand Temp: {'\n'} Min:  <strong>{(sandmintemp ?? 0).toFixed(1)} °C </strong></Typography>
//                 <Typography sx={{ whiteSpace: 'pre-line' }} variant='h8'>Max: <strong>{(sandmaxtemp ?? 0).toFixed(1)} °C </strong></Typography>
//               </Box>
//             </Box>

//             <Box sx={{
//               display: 'flex', width: '100%', padding: '5px', boxShadow: 'rgba(0, 0, 0, 0.07) 0px 1px 2px',
//             }}>
//               <Box sx={{ display: 'flex', gap: 2, justifyContent: 'center', width: '100%' }}>
//                 <Box sx={{ textAlign: 'center' }}>
//                   <Typography>Total batch: </Typography>
//                   <Typography sx={{ fontWeight: 600 }}>{todayTotalBatch}</Typography>
//                 </Box>
//                 <Box sx={{ textAlign: 'center' }}>
//                   <Typography>Good batch: </Typography>
//                   <Typography sx={{ fontWeight: 600 }}>{todayGoodBatch}</Typography>
//                 </Box>
//                 <Box sx={{ textAlign: 'center' }}>
//                   <Typography>Bad batch: </Typography>
//                   <Typography sx={{ fontWeight: 600 }}>{todayBadBatch}</Typography>
//                 </Box>
//                 <Box sx={{ textAlign: 'center' }}>
//                   <Typography>Good batch %: </Typography>
...
//             boxSizing: 'border-box', // Prevents overflow issues
//           }}>
//             <Typography sx={{ fontWeight: '600', background: '#ADDFFF', p: 0.5,paddingRight:10,paddingLeft:10 }} variant='h6'>This Week</Typography>
//             <Typography variant='h6'>{weekStart} - {weekEnd}</Typography>
...
//                 <Typography sx={{ whiteSpace: 'pre-line' }} variant='h8'>Avg Batch Time: {'\n'}<strong>{weekavgbatchtime} sec</strong></Typography>
//                 <Typography sx={{ whiteSpace: 'pre-line' }} variant='h8'>Avg Water: {'\n'} <strong>{(weekavgWater ?? 0).toFixed(1)} ltr</strong></Typography>
//                 <Typography sx={{ whiteSpace: 'pre-line' }} variant='h8'>Sand Temp: {'\n'} Min: <strong>{(weeksandmintemp ?? 0).toFixed(1)} °C</strong></Typography>
//                 <Typography sx={{ whiteSpace: 'pre-line' }} variant='h8'>Max: <strong>{(weeksandmaxtemp ?? 0).toFixed(1)}  °C</strong> </Typography>
//               </Box>
//             </Box>
...
//                 <Box sx={{ textAlign: 'center' }}>
//                   <Typography>Total batch: </Typography>
//                   <Typography sx={{ fontWeight: 600 }}>{weektotalbatch}</Typography>
//                 </Box>
//                 <Box sx={{ textAlign: 'center' }}>
//                   <Typography>Good batch: </Typography>
//                   <Typography sx={{ fontWeight: 600 }}>{weekGoodBatch}</Typography>
//                 </Box>
//                 <Box sx={{ textAlign: 'center' }}>
//                   <Typography>Bad batch: </Typography>
//                   <Typography sx={{ fontWeight: 600 }}>{weekbadbatch}</Typography>
//                 </Box>
//                 <Box sx={{ textAlign: 'center' }}>
//                   <Typography >Good batch %: </Typography>
//                   <Typography sx={{ fontWeight: 600 }}>
...
//             boxSizing: 'border-box', // Prevents overflow issues
//           }}>
//             <Typography sx={{ fontWeight: '600', background: '#ADDFFF', p: 0.5,paddingRight:10,paddingLeft:10 }} variant='h6'>This Month</Typography>
//             <Typography variant='h6'>{formattedMonth}</Typography>
...
//                   Avg Batch Time:
//                   {'\n'}
//                   <strong>{monthavgbatchtime} sec</strong>
//                 </Typography>

//                 <Typography sx={{ whiteSpace: 'pre-line' }} variant='h8'>Avg Water:
//                   {'\n'}
//                   <strong>{(monthavgWater ?? 0).toFixed(1)} ltr</strong>
//                 </Typography>
//                 <Typography sx={{ whiteSpace: 'pre-line' }} variant='h8'>Sand Temp{'\n'} Min: <strong>{(monthsandmintemp ?? 0).toFixed(1)} °C </strong></Typography>
//                 <Typography sx={{ whiteSpace: 'pre-line' }} variant='h8'>  Max: <strong>{(monthsandmaxtemp ?? 0).toFixed(1)} °C </strong></Typography>
//               </Box>
//             </Box>
...
//                 <Box sx={{ textAlign: 'center' }}>
//                   <Typography>Total batch: </Typography>
//                   <Typography sx={{ fontWeight: 600 }}>{monthtotalbatch}</Typography>
//                 </Box>
//                 <Box sx={{ textAlign: 'center' }}>
//                   <Typography>Good batch: </Typography>
//                   <Typography sx={{ fontWeight: 600 }}>{monthGoodBatch}</Typography>
//                 </Box>
//                 <Box sx={{ textAlign: 'center' }}>
//                   <Typography>Bad batch: </Typography>
//                   <Typography sx={{ fontWeight: 600 }}>{monthbadbatch}</Typography>
//                 </Box>
//                 <Box sx={{ textAlign: 'center' }}>
//                   <Typography>Good batch %: </Typography>
//                   <Typography sx={{ fontWeight: 600 }}>
...
//         <Divider />
//         <Box>
//           <Typography sx={{ mt: 2, fontWeight: 'bold', p: 0.1, background: '#addfff', textAlign: 'center' }} variant='h6' > Current Status</Typography>
//         </Box>
       
//         <Box sx={{
//           height: '14vh', display: 'flex', alignItems: 'center', justifyContent: 'space-evenly', m: 1,
//           // border:'1px solid #99A3A3'
//         }}>
//           <Card sx={{ height: '12vh', m: 1 }}>
//             <CardContent>
//               <Typography variant='h7' fontWeight={'bold'} color="text.secondary">
//                 Actual Compact
//               </Typography>
...
//               </Typography>
//               <Typography sx={{ fontWeight: 500, mt: 2 }} variant='h6'>
//                 <strong>{parseFloat(santemp).toFixed(2)}</strong>  %
//               </Typography>
//             </CardContent>
//           </Card>
...
//               </Typography>
//               <Typography sx={{ fontWeight: 500, mt: 2 }} variant='h6'>
//                 <strong>{parseFloat(totalwater).toFixed(2)}</strong>  %
//               </Typography>
//             </CardContent>
//           </Card>
...
const handleDateChange = (newDate) => {
  ...
  const startOfWeek = newDate.startOf('week');  // Get Monday
  const endOfWeek = newDate.endOf('week');      // Get Sunday
  setWeekStart(startOfWeek.format('DD-MM-YYYY'));
  setWeekEnd(endOfWeek.format('DD-MM-YYYY'));
    if (newDate) {
      const formattedDate = newDate.format('YYYY-MM-DD');
      fetch(`https://weaveitapp.microtechsolutions.net.in/api/kelsons/batchdata.php?date=${formattedDate}`, requestOptions)
        .then(response => {
          if (!response.ok) {
            throw new Error(`HTTP error! status: ${response.status}`);
          }
  ...
  const handleStatusChange = async (date) => {
    if (date) {
      const formattedDate = date.format('YYYY-MM-DD');
      const url = `https://weaveitapp.microtechsolutions.net.in/api/kelsons/currentstatus.php?todaydt=${formattedDate}`;
  ...
  const avgbatchdata1 = () => {
    ...
    fetch(`https://weaveitapp.microtechsolutions.net.in/api/kelsons/batchavgdata.php?date=${formattedDate}`, requestOptions)
      .then((response) => response.json())
      .then((result) => avgbatchdatamap(result))
      .catch((error) => console.error(error));
  }
    ...
    <Box className='dashboardcontainer'>
      ...
      <Box mt={2} className='maindash'>
        ...
        {/* <Box sx={{
          ...
          <Card sx={{ height: '12vh',width:140  }}>
            <CardContent>
              <Typography variant='h7' fontWeight={'bold'} color="text.secondary">
                Actual Compact
              </Typography>
              <Typography sx={{ fontWeight: 500, mt: 1}} variant='h6'>
                <strong>{actualcomp}</strong>  %
              </Typography>
            </CardContent>
          </Card>

          <Card sx={{ height: '12vh',ml:1,width:140 }}>
            <CardContent>
              <Typography variant='h7' fontWeight={'bold'} color="text.secondary">
                Target  Compact
              </Typography>
          ...
          <Card sx={{ height: '12vh', ml: 1 ,width:140}}>
            <CardContent>
              ...
              <Typography sx={{ fontWeight: 450, mt: 1 }} variant='h6'>
                <strong>{parseFloat(compensatecomp).toFixed(2)}</strong> %
              </Typography>
            </CardContent>
          </Card>
          ...
          <Card sx={{ height: '12vh', ml: 1 ,width:130}}>
            <CardContent>
              <Typography variant='h7' fontWeight={'bold'} color="text.secondary">
                Total <br /> water
              </Typography>
...
<Box sx={{display: 'flex', alignItems: 'center', justifyContent: 'space-between',}}>
          <Box mt={2}>
            ...
            <Typography sx={{ fontWeight: 500, mt: 1 ,textAlign:'center'}} variant='h6'>
              <strong>{actualcomp}</strong>  %
            </Typography>
          </Box>
